...
sap.ui.define([
	...
	"zjblesson/Market/model/formatter",
	"sap/ui/model/Filter",
	...
	return BaseController.extend("zjblesson.Market.controller.Worklist", {
		...
		onPressSayHello: function() {
			var sMessageText = this.getResourceBundle().getText("Say Hello");
