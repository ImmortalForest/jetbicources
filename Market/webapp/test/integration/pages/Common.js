sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblesson/Market/app", ".html");
		...
		return Opa5.extend("zjblesson.Market.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblesson/Market/localService/mockserver"], function (mockserver) {
